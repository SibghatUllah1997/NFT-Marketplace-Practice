...
contract NFTPractice is ERC1155, Ownable {
    ...
    function ListProduct(
        ...
        require(balanceOf(msg.sender,_ProductId)>ProductDetail[_ProductId].price,"Not enough tokens");
    ...
    function Sale(uint256 _ProductId , uint AmountNft, address _to) public payable {
     require(ProductDetail[_ProductId].Amount >= AmountNft ,"you have Insufficent Tokens");
